...
import CompButten from "./CompButten";
/**
 ...
 *          CpmpCount에게 전달 : 변수 ={state변수}
 *          countArg 이름으로 count state변수를 전달한다
 * 3. CompCount에서 state변수 받기 : CompCount.jsx로 jump
 *
 * 5. CompButton count 변수를 변화시킬때 사용할 setCount함수를 전달한다
 *6. CompButton에서 setCount함수 받기 : CompButton.jsx로 jump
 */
function CompBody(props) {
  ...
  return (
    <div>
      ...
      <CompButten setCountFunc={setCount} countArg={count} />
    </div>
  );
}
