 ...
 * 함수 방식에서 바로 나타나던 return문이 render() method 내부에 위치한다
 */
...
class TodoMain extends Component {
  ...
  /**
   * 클래스 방식의 main 에서 event 함수를 선언하는 방법
  ...
  onToggle = (id) => {
    ...
    const commpTodoList = todoList.map((todo) => {
     ...
     */
    this.setState({ todoList: commpTodoList });
  };
